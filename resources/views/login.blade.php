...
<head>
    ...
    <title>Login - MediWork System</title>
...
<body class="login-page sidebar-collapse">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://github.com/creativetimofficial/now-ui-kit/issues">¿Tienes un problema?</a>
                    </li>
                    <li class="nav-item">
 ...
 {!!Form::submit('Iniciar',['class'=>'btn btn-info btn-round btn-lg btn-block'])!!}
                          </div> 
                        </div>
                        ...
                        <div class="pull-left">
                            ...
                            <h6>
                                <a href="{!! URL::to('/register') !!}" class="link">Create Account</a>
                            </h6>
                        </div>
